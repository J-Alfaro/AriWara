					...
					<table class="lumise_table">
						...
						<tbody>
							...
							if(count($orders['rows']) > 0){
								...
								?>
								<tr>
									<td><a href="<?php echo $lumise_router->getURI();?>lumise-page=order&order_id=<?php echo $item['id'];?>">#<?php echo $item['id'];?></a></td>
									...
									<td><a href="<?php echo $lumise_router->getURI();?>lumise-page=order&order_id=<?php echo $item['id'];?>">View</a></td>
								</tr>
								<?php
								}
							}else{
